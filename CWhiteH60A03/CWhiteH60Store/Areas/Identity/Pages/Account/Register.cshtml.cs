...
namespace CWhiteH60Store.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            ICustomerRepository<Customer> customerRepo)
        {
        ...
        public class InputModel
        {
            ...
            public enum UserRoles { Clerk, Manager }
        }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (role is InputModel.UserRoles.Clerk or InputModel.UserRoles.Manager) {
                var user = CreateUser();
                ...
                var successful = await _customerRepo.Create(customer);
